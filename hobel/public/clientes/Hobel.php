...
<body>
    ...
    <header class="header">
        <nav style="height: fit-content;">
            <div class="logo">
                <img class="logorotate" src="img/logohobel.png" alt="" style="max-width: 150px;">
            </div>
            <div class="search">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><a href="registro.html" class="cta">Registrarse</a></li>
                    <li><a href="registro.html" class="cta" id="login">Acceder</a></li>
                </ul>
            </div>
        </nav>
        ...
        <div class="textos-header">
                ...
                <div class="botones">
                    <button>
                        <img src="./img/casa-icono.png" style="max-width: 500px; margin-right: 20px; margin-left: 0px;">
                        Hogar
                    </button>
                    <button>
                        <img src="./img/deporte-icono.png" style="max-width: 500px; margin-right: 20px; margin-left: 0px;">
                        Deporte
                    </button>
                    <button>
                        <img src="./img/clases-icono.png" style="max-width:500px; margin-right: 20px; margin-left: 0px;">
                        Clases
                    </button>
                    <button>
                        <img src="./img/belleza-icono.png" style="max-width: 500px; margin-right: 20px; margin-left: 0px;">
                        Belleza
                    </button>
                    <button>
                        <img src="./img/mascota-icono.png" style="max-width: 500px; margin-right: 20px; margin-left: 0px;">
                        Mascota
                    </button>
                    <button>
                        <img src="./img/cuidados-icono.png" style="max-width: 500px; margin-right: 20px; margin-left: 0px;">
                        Cuidados
                    </button>
                </div>
    ...
    <section class="ola-contenedor website">
        ...
        <div class="divimg">
            <img src="img/Alta hobel.png" alt="">
        </div>
    ...
    <section class="galeria">
        <div class="contenedor">
            ...
            <article class="galeria-contenedor">
                <img src="img/malagalocation.webp" alt="">

                <img src="img/madridlocation.webp" alt="">
                <img src="img/barcelonalocation.webp" alt="">
                <img src="img/valencialocation.webp" alt="">
                <img src="img/bilbaolocation.webp" alt="">
                <img src="img/cadizlocation.webp" alt="">
    ...
    <section class="info-last">
        <div class="contenedor last-section">
            ...
            <img class="zoom" src="img/amigos.webp" alt="">
